...
public class StoreAddItemMenuController {
...
//                System.out.println(DATA.path);
    ...
    @FXML public void open_prod(){
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("StoreAddItemMenu.fxml"));
    ...
    @FXML public void add_prod(){
        ...
        try {
            DATA.cur_storeAdmin.getStore().store_inventory.insert(current_instance+">"+DATA.curr_prodcut.getName(), DATA.curr_prodcut);
