...
//                System.out.println(DATA.path);
    ...
    @FXML public void set_category(){
        ...
        System.out.println(current_instance+">"+DATA.currentCategoryString);

        try {
            DATA.cur_warehouseAdmin.getWarehouse().warehouse_inventory.delete(current_instance+">"+DATA.currentCategoryString);
